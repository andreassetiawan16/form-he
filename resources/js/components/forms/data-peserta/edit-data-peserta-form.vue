<template>
  <div class="container-fluid">
    ...
    <success-modal>
      {{ `Berhasil update data peserta ${peserta.nama}` }}
    </success-modal>
    ...
    <button class="btn btn-info" @click="updatePeserta">Save</button>
...
export default {
  ...
  mounted () {
    this.peserta = Object.assign({}, JSON.parse(this.datapeserta))
